                          ...
                          <div className="form-login-cover">
                            ...
                            <form className="login-register text-start mt-20" action="#">
                              <div className="form-group">
                                <label className="form-label" for="input-1">Your Password *</label>
                                <input className="form-control" id="input-1" type="password" required="" name="password"
                                  placeholder="************" />
                              </div>
                              <div className="form-group">
                                <button className="btn btn-brand-1 hover-up w-100" type="submit" name="login">Submit</button>
                              </div>
                              <div className="text-muted text-center">Don't Have Passoword?<a href="page-contact.html">Contact
                                Us</a></div>
                            </form>
                          </div>
                        </div>
              ...
              <div className="modal-body pl-30 pr-30 pt-50">
                ...
                <form className="login-register text-start mt-20 pb-30" action="#">
                  ...
                  <div className="form-group">
                    ...
                    <input className="form-control" id="number" type="text" required="" name="phone"
                      placeholder="(+01) 234 567 89" />
                  </div>
                  <div className="form-group">
                    <label className="form-label" for="des">Description</label>
                    <input className="form-control" id="des" type="text" required="" name="Description"
                  ...
                  <div className="login_footer form-group d-flex justify-content-between">
                    <label className="cb-container">
                      <input type="checkbox" /><span className="text-small">Agree our terms and policy</span><span
                  ...
                  <div className="text-muted text-center">Do you need support? <a href="page-contact.html">Contact Us</a>
                  </div>
                </form>
              </div>
            </div>
