        ...
        <Layout>
            <div className="box-heading">
                <div className="box-title">
                    <h3 className="mb-35">Create New Account</h3>
                </div>
                                                ...
                                                <div className="form-login-cover">
                                                    ...
                                                    <form className="login-register text-start mt-20" action="#">
                                                        ...
                                                        <div className="login_footer form-group d-flex justify-content-between">
                                                            ...
                                                            </label><a className="text-muted" href="#">Lean more</a>
                                                        </div>
                                                        <div className="form-group">
                                                            <button className="btn btn-brand-1 hover-up w-100" type="submit" name="login">Submit &amp; Register</button>
                                                        </div>
                                                        <div className="text-muted text-center">Already have an account? <a href="login.html">Sign in</a></div>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
